...
function tampilmanager()
{
		...
		$("#grid1").kendoGrid({
		 ...
		 transport: {
					read: 
						{
							url: 'http://localhost/sunson/admin/cspl/getjson_popupmanager?field='+ cari,
