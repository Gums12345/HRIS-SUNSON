...
<script type="text/javascript">
						  ...
						  $( window ).on( "load", function() {
						   ...
						   $('#simpan').on('click', function(){
							...
							$('#add').on('click', function(){
								window.location = '<?php echo base_url(); ?>cmasterpelanggaran/tambah_masterpelanggaran';
							});
						  });
 ...
 <div id="content" class="">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Edit Master Pelanggaran</h2>
 ...
 <div  id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
              ...
              <form id="form2" name="form2" method="" action=""  >
                  ...
                  <a href="<?php echo base_url(); ?>cmasterpelanggaran/tampil" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
