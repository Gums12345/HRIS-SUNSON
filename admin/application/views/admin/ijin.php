 ...
 <div id="content" class="">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Ijin</h2>
    ...
    <div class="box-content">
                  ...
                  <div class="box-tools" style="float:right">
                     <form id="form2" name="form2" method="POST" action="<?php echo base_url();?>cijin/tampil"  >
 				...
 				<div style="width:100px; margin-top:-20px" >
                  <h3 >
                  	<a href="<?php echo base_url(); ?>cijin/tambah_ijin" class="btn btn-sm btn-primary btn-flat"><i class="fa fa-edit"></i> Tambah</a>
                  </h3>
                   </div><!-- /.box-header -->
</form>
    ...
    <tr>
     ...
     <td><?php echo $lihat->ket ?></td>
        ...
        <td class="center">
            ...
            <div align="right"><a class="btn btn-info" href="<?php echo base_url(); ?>cijin/editijin/<?php echo $lihat->idijin?>">
                  <i class="glyphicon glyphicon-edit icon-white"></i>
                  </a>
                <a class="btn btn-danger" href="<?php echo base_url(); ?>cijin/hapusijin/<?php echo $lihat->idijin?>">
