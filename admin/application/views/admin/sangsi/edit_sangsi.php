...
<script type="text/javascript">
						 ...
						 hgt = taskb -174;
						   ...
						   $('#simpan').on('click', function(){
							...
							$('#add').on('click', function(){
								window.location = '<?php echo base_url(); ?>csangsi/tambah_sangsi';
							});
						  });
 ...
 <div id="content" class="">
     ...
     <div>
       <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url();?>csangsi/tampil">Sangsi</a>
            </li>
            <li>
                <a href="#">Tambah</a>
            </li>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Edit Sangsi</h2>
 ...
 <div  id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
              ...
              <form id="form2" name="form2" method="" action=""  >
                         ...
                         <input type="text" class="form-control" name="kdsangsi"  id="kdsangsi" placeholder="Kode"/>
    
                        <label for="exampleInputEmail1">Sangsi</label>
                          <input type="text" class="form-control" name="sangsi" id="sangsi"   placeholder="Sangsi"/>
                  ...
                  <a href="<?php echo base_url(); ?>csangsi/tampil" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
