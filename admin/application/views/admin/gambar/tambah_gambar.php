...
<script type="text/javascript">
 ...
 <div id="content" class="col-lg-10 col-sm-10">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Tambah Gambar</h2>
 ...
 <div  id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
              ...
              <?php /*?><?php echo form_open_multipart('cgambar/upload',array('name'=>'form2'),array('id'=>'form2'));?><?php */?>
