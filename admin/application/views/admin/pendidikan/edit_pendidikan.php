...
<script type="text/javascript">
						 ...
						 showfield();
						   ...
						   $('#simpan').on('click', function(){
							...
							$('#add').on('click', function(){
								window.location = '<?php echo base_url(); ?>cpendidikan/tambah_pendidikan';
							});
						  });
 ...
 <div id="content" class="">
     ...
     <div>
         <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url(); ?>cpendidikan/tampil">Pendidikan</a>
            </li>
            <li>
                <a href="#">Tambah</a>
            </li>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Edit Pendidikan</h2>
 ...
 <div  id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
              ...
              <form id="form2" name="form2" method="" action=""  >
                         ...
                         <input type="text" class="form-control" name="kdpendidikan"  id="kdpendidikan" placeholder="Kode"/>
                  ...
                  <a href="<?php echo base_url(); ?>cpendidikan/tampil" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
