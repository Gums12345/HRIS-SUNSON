...
<script type="text/javascript">
						 ...
						 showfield();
						   ...
						   $('#simpan').on('click', function(){
							...
							$('#add').on('click', function(){
								window.location = '<?php echo base_url(); ?>clibur_nasional/tambah_libur_nasional';
							});
						  });
 ...
 <div id="content" class="">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Edit Libur Nasional</h2>
 ...
 <div  id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
              ...
              <form id="form2" name="form2" method="" action=""  >
                         ...
                         <input type="text" class="form-control" name="tgl"  id="tgl" placeholder="Kode"  title="date"/>
    
                        <label for="exampleInputEmail1">Keterangan</label>
                          <input type="text" class="form-control" name="libur_nasional" id="libur_nasional"   placeholder="libur_nasional"/>
                  ...
                  <a href="<?php echo base_url(); ?>cliburnasional/tampil" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
