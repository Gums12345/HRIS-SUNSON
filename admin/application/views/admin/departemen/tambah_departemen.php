 ...
 <div id="content" class="">
     ...
     <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url();?>cdepartemen/tampil">Departemen</a>
            </li>
            <li>
                <a href="#">Tambah</a>
            </li>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Tambah Departemen</h2>
 ...
 <div id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
                <!-- form start -->
                 ...
                 <form id="form2" name="form2" method="" action=""  >
                         ...
                         <input type="text" class="form-control" name="kddepartemen"  id="kddepartemen" placeholder="Kode"/>
                      ...
                      <a href="<?php echo base_url(); ?>cdepartemen/tampil" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Back</a>
