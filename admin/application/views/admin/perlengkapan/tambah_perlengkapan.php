...
<script type="text/javascript">
						 ...
						 showfield();
						   ...
						   $('#simpan').on('click', function(){
							...
							$('#add').on('click', function(){
								window.location = '<?php echo base_url(); ?>cperlengkapan/tambah_perlengkapan';
							});
						  });
 ...
 <div id="content" class="col-lg-10 col-sm-10">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Tambah Perlengkapan</h2>
 ...
 <div  id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
              ...
              <form id="form2" name="form2" method="" action=""  >
                         ...
                         <input type="hidden" name="idperlengkapan" value="">
                         
                        
                           <label for="exampleInputEmail1">Perlengkapan</label>
                         <input type="text" class="form-control" name="nama"  id="nama" placeholder="Perlengkapan"/>
                  ...
                  <a href="<?php echo base_url(); ?>cperlengkapan/tampil" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
