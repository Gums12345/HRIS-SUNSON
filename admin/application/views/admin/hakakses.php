  ...
  var nik;
					$(document).ready(function() {
							 ...
							 $('#groupinput').height(hgt-86);
								 ...
								 showcombo('./urlcmb?link=<?php echo encrypt_url("SELECT iduser as id, nama FROM sysuser where idkaryawan  is not null") ;?>','iduser');							 
								...
								$("#iduser").change(function(){
										...
										$.ajax({
										  ...
										  success: function(data)
											  {
												idkaryawan = data[0].idkaryawan;
					
												nik = data[0].nik;
												$("#tree-container").jstree().deselect_all(true);
												/*checked fom database*/
												$.ajax({
													  url : "./tandaibox",
													  type: "get",
													  data:{id:idkaryawan},
												...
												/*$.each(selectedNodes, function() {				
													$("#tree-container").jstree("check_node","004");							
												});*/
												...
												$.each(selectedNodes, function() {
													checked_ids.push(this.id);
														...
														$.ajax({
															  url : "./insertdata",
															  type: "post",
															  data:{idkaryawan:idkaryawan,nik:nik,fcode:this.id,userid:userid},
															  async: true,
															  dataType: "json",
															  success: function(data)
																  {
